...
4. ROOM SIZING: Place higher-draw sessions in larger rooms.
   - AI/ML and Application Development sessions tend to draw large crowds -> prefer Rooms 1 (388), 5 (340), 2 (314)
   - Architecture sessions also draw well -> prefer Rooms 1-6
   - Niche/specialized sessions (Other, Data Engineering) -> fine in smaller Rooms 7 (224), 8 (173)
   - Well-known speakers with broad-appeal topics should get larger rooms
